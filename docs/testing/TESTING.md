...
| End-to-end (E2E) | `integration_test/*_test.dart` | 10 | _TBD_ | _TBD_ | _TBD_ | _TBD_ |
| Authenticated E2E | `integration_test/*_authenticated_test.dart` | 9 | _TBD_ | _TBD_ | _TBD_ | _TBD_ |
| **Total** | | **20** | _TBD_ | _TBD_ | _TBD_ | _TBD_ |
